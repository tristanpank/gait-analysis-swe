        ...
        <header className={"flex z-[10] fixed top-0 w-screen p-0 m-0 border-box " + headerColor}>
            <div className="flex items-center w-full ">
                ...
                <NavigationMenu>
                    <NavigationMenuList>
                        <NavigationMenuItem>
                            <NavigationMenuLink href='/dashboard' className='mr-5 text-black font-semibold hover:text-blue-600'>Dashboard</NavigationMenuLink>
                        </NavigationMenuItem>
                        <NavigationMenuItem>
                            <NavigationMenuLink href='/upload' className="mr-5 text-black font-semibold hover:text-blue-600">Upload Video</NavigationMenuLink>
                        </NavigationMenuItem>
                    </NavigationMenuList>
                </NavigationMenu>
            </div>
