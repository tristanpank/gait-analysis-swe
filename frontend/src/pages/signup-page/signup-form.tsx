...
export function SignupForm(props) {
  ...
  return (
    <div data-testid="Signup Form" className="max-w-md h-full md:h-auto w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
